...
const sections = [
  ...
  },
  {
    ...
    body: "على البائع تقديم وصف دقيق للمنتجات وصور حقيقية، والالتزام بمدة التجهيز المعلنة، والتواصل مع المشتري عند وجود أي مشكلة. تخضع منتجات البائعين لمراجعة الإدارة.",
  },
  {
