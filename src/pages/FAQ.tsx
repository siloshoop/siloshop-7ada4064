...
const faqCategories = [
  {
    ...
    questions: [
      { question: "كيف يمكنني تقديم طلب؟", answer: "تصفّح المنتجات، أضِف ما تريده إلى السلة، ثم انتقل إلى صفحة الدفع وأكمل معلومات الشحن والدفع لإتمام الطلب." },
      ...
      { question: "ما هي طرق الدفع المتاحة؟", answer: "الدفع عند الاستلام، التحويل البنكي، بطاقات الائتمان والخصم، والمحافظ الإلكترونية المحلية." },
  ...
  },
  {
    ...
    questions: [
      ...
      { question: "هل يمكنني تحديد وقت التوصيل؟", answer: "نعم، يتصل بك المندوب قبل الوصول، ويمكنك إعادة جدولة التوصيل مرة واحدة مجاناً." },
  ...
  },
  {
    ...
    questions: [
      ...
      { question: "كيف أطلب إرجاع أو استبدال؟", answer: "تواصل مع خدمة العملاء من صفحة (اتصل بنا) لتزويدك برقم إرجاع وتعليمات الشحن." },
  ...
  },
  {
    ...
    questions: [
      ...
      { question: "هل يمكنني الحصول على خصومات للطلبات الكبيرة؟", answer: "نعم، تطبَّق خصومات تلقائية على الكميات الكبيرة، ويمكنك استخدام أكواد الخصم في صفحة الدفع." },
