...
const faqCategories = [
  {
    ...
    image: faqOrders,
    description: "كل ما يخص تقديم الطلبات وإلغائها وتتبعها",
    questions: [
      ...
      { question: "هل يمكنني إلغاء طلبي بعد تقديمه؟", answer: "يمكنك إلغاء الطلب قبل أن يقوم البائع بشحنه. إذا كانت حالة الطلب \"قيد الانتظار\"، \"تم التأكيد\"، أو \"قيد المعالجة\"، يمكنك الضغط على زر \"إلغاء الطلب\" من صفحة تفاصيل الطلب أو من صفحة \"طلباتي\". بعد شحن الطلب، لن يكون الإلغاء متاحًا، ويمكنك التواصل مع خدمة العملاء إذا احتجت إلى المساعدة." },
      { question: "ما هي طريقة الدفع المتاحة؟", answer: "طريقة الدفع الوحيدة المتاحة حالياً هي الدفع عند الاستلام (COD). يدفع العملاء ثمن طلباتهم فقط عند استلامها. لا تتوفر أي وسائل دفع إلكترونية في الوقت الحالي." },
  ...
  },
  {
    ...
    title: "الإرجاع",
    image: faqReturns,
    description: "سياسة واضحة لإرجاع المنتجات",
    questions: [
      { question: "ما هي مدة الإرجاع؟", answer: "7 أيام من تاريخ الاستلام، شرط أن يكون المنتج بحالته الأصلية مع العبوة والفاتورة. بعد انتهاء المدة يختفي زر (طلب إرجاع) تلقائياً." },
      ...
      { question: "كيف أطلب إرجاع منتج؟", answer: "من صفحة (طلباتي)، افتح تفاصيل الطلب واضغط على (طلب إرجاع). اختر سبب الإرجاع، اكتب وصفاً للمشكلة (إلزامي)، وارفق حتى 5 صور إن لزم. أرسل الطلب وسيراجعه البائع. يمكنك متابعة حالة طلب الإرجاع من صفحة (طلباتي) أو (طلبات الإرجاع)، وإذا تمت الموافقة ستصلك تعليمات إرجاع المنتج." },
      { question: "كيف يتم إرجاع المبلغ عند الدفع عند الاستلام؟", answer: "إذا تمت الموافقة على طلب الإرجاع، يجب على العميل إعادة المنتج أولًا. بعد استلام المنتج وفحصه والتأكد من مطابقته لشروط الإرجاع، يقوم البائع بإعادة المبلغ إلى العميل وفقًا لسياسة المتجر. يمكن متابعة حالة طلب الإرجاع بالكامل من داخل الموقع." },
    ],
  },
  {
    id: "account",
