...
const sellerStatusMeta: Record<string, { label: string; color: string; desc: string }> = {
  pending: { label: "قيد المراجعة", color: "bg-warning", desc: "طلب متجرك قيد مراجعة الإدارة" },
  approved: { label: "متجر مفعّل", color: "bg-success", desc: "متجرك مفعّل — اذهب إلى لوحة البائع" },
