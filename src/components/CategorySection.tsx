          ...
          {displayCategories.map((category, index) => {
            ...
            return (
              <Card
                ...
                className={cn(
                  `category-card group cursor-pointer overflow-hidden border-2 border-transparent hover:border-primary/30 shadow-lg hover:shadow-2xl active:scale-[0.96] active:shadow-inner transition-transform transition-shadow duration-150 ease-out`,
                  category.bgColor,
                  isExpanded && "col-span-2 row-span-2",
                  isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
                )}
                style={{ transitionDelay: `${100 + index * 30}ms` }}
              ...
              >
                <div className={cn(
                  ...
                  <div className={`absolute inset-0 bg-gradient-to-br ${category.gradient} opacity-0 motion-safe:group-hover:opacity-10 transition-opacity duration-150 pointer-events-none`} />
                  
                  <div className="relative z-10 space-y-3 w-full">
                    <div className="flex items-center justify-center gap-2">
                      <div className={`category-card-icon w-10 h-10 md:w-12 md:h-12 rounded-xl bg-gradient-to-br ${category.gradient} p-0.5 motion-safe:group-hover:scale-110 group-active:scale-95 transition-transform transition-shadow duration-150 shadow-lg group-active:shadow-inner`}>
                        <div className="w-full h-full bg-background rounded-xl flex items-center justify-center">
                          <IconComponent className={`w-5 h-5 md:w-6 md:h-6 ${category.iconColor} motion-safe:group-hover:scale-110 transition-transform duration-150`} />
                        </div>
                      </div>
                    </div>
